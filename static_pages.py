...
{SITE_HEADER}
  ...
  additional withholding. Federal and state tax brackets, standard deductions, and FICA rates/caps
  are for the 2026 tax year and are refreshed periodically as the IRS and state revenue departments
  publish updated figures. Local/city income taxes (e.g. New York City) are not included.</p>
...
{SITE_HEADER}
  ...
  you type into the calculator - all calculations run locally in your browser. Third-party services
  such as Google AdSense and Google Analytics may automatically collect cookie-based data (pages
  visited, device type, approximate location) for advertising and analytics purposes.</p>
